...
public class ApptRandomTest {
    ...
    public static String RandomSelectMethod(Random random) {
        String[] methodArray = new String[]{"setTitle", "setRecurrence", "setStartYear", "setStartMonth", "setStartDay", "setStartHour", "setStartMinute"};// The list of the of methods to be tested in the Appt class
                ...
                for (int iteration = 0; elapsed < TestTimeout; iteration++) {
                    ...
                    for (int i = 0; i < NUM_TESTS; i++) {
                        ...
                        if (methodName.equals("setTitle")) {
                            ...
                            boolean fill = ValuesGenerator.getBoolean((float)0.5, random);
                            int sizeArray;
                            int[] recurDays;
                            if(fill){
                            ...
                            int newStartDay = ValuesGenerator.getRandomIntBetween(random, 0, CalendarUtil.NumDaysInMonth(startYear, startMonth - 1));
